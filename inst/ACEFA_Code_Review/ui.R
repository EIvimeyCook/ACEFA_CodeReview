...
")),
    ...
    bslib::layout_sidebar(
      ...
      create_card("3", "Is it clear what needs to be installed for this code to be run? Is it clear how to run it? Run the code and comment on any issues encountered."),
      hr(),
      div(id = "stage4_title",
